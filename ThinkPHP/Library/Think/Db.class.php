...
class Db {
    ...
    protected function debug() {
        ...
        if (C('DB_SQL_LOG')) {
            G('queryEndTime');
            Log::write($this->queryStr.' [ RunTime:'.G('queryStartTime','queryEndTime',6).'s ]','SQL','File',APP_PATH.'../log/'.date('Ymd').'.log');
            trace($this->queryStr.' [ RunTime:'.G('queryStartTime','queryEndTime',6).'s ]','','SQL',true);
        }
    }
