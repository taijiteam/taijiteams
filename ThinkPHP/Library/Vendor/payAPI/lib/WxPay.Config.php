...
// //商户基本信息
// defined('APPID') || define('APPID','wxc0a07eb0a480bd56');//APPID
// defined('MCHID') || define('MCHID', '1485780372');//商户号
// defined('KEY') || define('KEY', 'taiji999999999999999999999999999');//密钥
// defined('APPSECRET') || define('APPSECRET', '5b7af4e7e07f1fcf1b4ca8b720cd11d3');//appsecret
...
class WxPayConfig
{
  //=======【基本信息设置】=====================================
	 ...
	 * @var string
	 */
	const APPID = 'wxc0a07eb0a480bd56';
	const MCHID = '1485780372';
	const KEY = 'taiji999999999999999999999999999';
	const APPSECRET = '5b7af4e7e07f1fcf1b4ca8b720cd11d3';
