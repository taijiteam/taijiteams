...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 800
            ,url: '/Admin/Order/check_list?source=<?php echo ($source); ?>'//数据接口
            ,title: '商城审核表'
            ,page: true //开启分页
            ,totalRow: true //开启合计行
            ,cols: [[ //表头
                ...
                ,{field: 'goods_num', title: '数量', width:80, sort: true,totalRow: true}
                ...
                ,{field: 'pocket_value', title: '使用积分', width: 100, sort: true,totalRow: true}
