...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#demo'
            ,height: 800
            ,url: '/Admin/Order/check_DoctorList?source=<?php echo ($source); ?>'//数据接口
            ,title: '医疗审核表'
            ,page: true //开启分页
            ,totalRow: true //开启合计行
            ,cols: [[ //表头
                {type: 'checkbox', fixed: 'left'}
                ,{field: 'order_Id', title: 'ID', width:80, sort: true, fixed: 'left',totalRowText: '合计：'}
                ,{field: 'order_number', title: '订单号', width:177}
                ,{field: 'order_doctor', title: '预约医生', width:150}
                ,{field: 'order_dohospital', title: '预约医院', width:150}
                ,{field: 'order_user', title: '付款人', width:80}
                ,{field: 'order_uphone', title: '手机号', width:177}
                ,{field: 'order_money', title: '支付价格', width: 100, sort: true,totalRow: true}
