...
<div class="x-body">
    ...
    <table class="layui-table x-admin">
        ...
        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                ...
                <?php if($vo["order_status"] == 7): ?><td style="background-color: 	#C3C3C3">驳回审核</td>
                ...
                <td class="td-manage" style="font-size: 14px;">
                    ...
                    <a title="审核" href="javascript:;" onclick="x_admin_show('审核','/Admin/Order/audit?order_id=<?php echo ($vo["id"]); ?>&source=机场',450,350)">
