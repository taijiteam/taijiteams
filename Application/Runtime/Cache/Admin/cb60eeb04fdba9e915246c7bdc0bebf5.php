  ...
  <body>
    ...
    <div class="x-body">
      ...
      <table class="layui-table x-admin">
        ...
        <tbody>
        <?php if(is_array($search)): $k = 0; $__LIST__ = $search;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            <td>
            ...
            <td class="td-statuss">
              <span class="layui-btn layui-btn-normal layui-btn-mini" onclick="x_admin_show('详情','/Admin/Sort//sortDefatu?id=<?php echo ($vo["a_aid"]); ?>',500,420)"  href="javascript:;">积分编辑</span>
    ...
    <script>
      ...
      $("#btn").click(function() {
        ...
        //alert(cname)
        $.ajax({
          url:"<?php echo U('Index/memberSearch');?>",
          type:"post",
