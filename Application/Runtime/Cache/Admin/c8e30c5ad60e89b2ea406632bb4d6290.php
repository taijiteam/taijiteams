        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="category" name="category" autocomplete="off" class="layui-input">
                    <?php switch($res["m_category"]): case "商政名流": ?><option selected value="商政名流">商政名流</option>
                        ...
                        <?php default: ?>
                            ...
                            <option value="企业精英">企业精英</option>
                            <option value="文艺雅仕">文艺雅仕</option>
                            <option value="名医专家">名医专家</option><?php endswitch;?>
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="sex" name="sex" autocomplete="off" class="layui-input">
                    <?php switch($res["m_sex"]): case "先生": ?><option selected value="先生">先生</option>
                            <option value="女士">女士</option><?php break;?>
                        <?php case "女士": ?><option value="先生">先生</option>
                            <option selected value="女士">女士</option><?php break;?>
                        <?php default: endswitch;?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="starte" name="starte" autocomplete="off" class="layui-input">
                    <?php switch($res["m_starte"]): case "0": ?><option selected value="0">展示</option>
                            <option value="1">禁用</option>
                            <option value="2">官员</option><?php break;?>
                        <?php case "1": ?><option value="0">展示</option>
                            <option selected value="1">禁用</option>
                            <option value="2">官员</option><?php break;?>
                        <?php case "2": ?><option value="0">展示</option>
                            <option value="1">禁用</option>
                            <option selected value="2">官员</option><?php break;?>
                        <?php default: endswitch;?>
                </select>
            </div>
        </div>
...
<script type="text/javascript" >
    ...
    var set = ue.ready(function() {
        ue.setContent('<?php echo ($res["m_introduce"]); ?>');
    });
    //提交
