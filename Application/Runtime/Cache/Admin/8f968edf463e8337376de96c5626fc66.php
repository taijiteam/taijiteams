...
<div class="x-body">
    <div class="layui-collapse" lay-filter="test">
        <div class="layui-colla-item">
            ...
            <div class="layui-colla-content">
                <form method="post" action="/Admin/Order/projectSearch?source=美食" class="layui-form layui-col-md12 x-so" >
                    <div class="layui-row">
    ...
    <table class="layui-table x-admin">
        ...
        <?php if(is_array($orderList)): $k = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                ...
                <td><?php echo ($vo["o_user"]); ?>:<?php echo ($vo["o_phone"]); ?></td>
                <td><?php echo ($vo["o_shopid"]); ?></td>
                <td><?php echo ($vo["o_aprace"]); ?></td>
                <?php if($vo["o_state"] == 7): ?><td style="background-color: 	#C3C3C3">驳回审核</td>
                    <?php elseif($vo["o_state"] == 3): ?><td style="background-color: rgba(4,174,115,0.42)">交易完成</td>
...
<script>
    $("#btn").click(function () {
        ...
        $.ajax({
            url : "/Admin/Order/search?source=美食",
            type: "post",
            data:{
                //pay         : pay,
                audit       : audit,
