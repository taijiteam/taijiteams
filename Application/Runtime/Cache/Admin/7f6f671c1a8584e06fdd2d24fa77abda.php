...
<div class="x-body">
    <form class="layui-form">
        <div class="layui-form-item">
            <label for="cname" class="layui-form-label"><span class="x-red">*</span>商铺ID</label>
        ...
        <div class="layui-form-item">
            <label for="phone" class="layui-form-label"><span class="x-red">*</span>商铺名称</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="workunits" class="layui-form-label">联系人</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="socialposition" class="layui-form-label">联系电话</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="address" class="layui-form-label">商铺地址</label>
            <div class="layui-input-inline">
