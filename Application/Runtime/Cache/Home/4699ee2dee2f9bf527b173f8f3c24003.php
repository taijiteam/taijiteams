...
<div class="depa">
	<h3><img src="/Public/Doctor/images/qita.png">科室分类</h3>
	<ul class="nav">
		<a href="<?php echo U('Doctor/department_list');?>?de_department=ICU">
			<li>
				<span><img src="/Public/Doctor/images/ICU.png"></span>
				<p>ICU</p>
			</li>
		</a>
		...
		<!--<a href="<?php echo U('Doctor/department_list');?>?de_department=消化科">-->
		<a href="<?php echo U('Doctor/department_list');?>?de_department=手术">
			<li>
				<span><img src="/Public/Doctor/images/gangchangke.png"></span>
				<p>消化科</p>
			</li>
		</a>
		...
		<a href="<?php echo U('Doctor/department_list');?>?de_department=手术s">
			<li>
