...
<header class="cheader">
	<div>
		<p><img src="/Public/Airport/images/index2.png"></p>
	</div>
...
<div class="body">
	...
	<form>
		...
		<input type="hidden" name="name" value="<?php echo ($_SESSION['infor']['data'][0]['TrueName']); ?>"/>
		<input type="hidden" name="phone" value="<?php echo ($_SESSION['infor']['data'][0]['Mobile']); ?>"/>
...
<script type="text/javascript">
	function feedback1(){
		...
		if(name == ''){
			...
			$.ajax({
				type:"post",
				url:"<?php echo U('Project/feedback1');?>",//根据自己项目的需要写请求地址
				data:{
						'name':name,
						'phone':phone,
						'cardid':cardid,
